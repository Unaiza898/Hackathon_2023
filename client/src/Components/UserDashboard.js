  ...
  return (
    <div className="dashboard-information">
      <div className="dashboard-welcome">
        ...
        <div>
          This dashboard helps you compare your past spending patterns to
          current inflation rates, job security patterns and cyber security
          concerns.
        </div>
      </div>
      ...
      <div className="dashboard-page">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="/monthlyBudget" class="btn btn-primary">
              YOUR BUDGET
            </a>
          </div>
        </div>
